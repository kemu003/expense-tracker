                ...
                <div className="h-3 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden">
                  <div
                    ...
                    style={{
                      width: `${pct}%`,
                      maxWidth: '100%',
                      backgroundColor: over ? '#ef4444' : critical ? '#f59e0b' : warning ? '#3b82f6' : color,
                    }}
                  />
                </div>
